...
courseRouter.put("/edit-course/:id", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("user"), course_controller_1.editCourse);
...
courseRouter.put("/add-questions", auth_1.isAuthenticated, course_controller_1.addQuestion);
